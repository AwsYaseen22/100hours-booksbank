...
// show add new book
exports.showAddBook = (request, response) => {
...
// show public books
exports.publicBooks = async (request, response) => {
  try {
...
exports.bookDetails = async (request, response) => {
  try {
...
exports.userBooks = async (request, response) => {
  try {
...
// show EDIT book page
exports.showEditBook = async (request, response) => {
  try {
